    ...
    <footer className="py-16 px-6 border-t border-border">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="text-[10px] text-muted-foreground/30 font-sans tracking-wide">
            © {new Date().getFullYear()} Stone Fungus. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
  ...
  return (
    <footer className="py-16 px-6 border-t border-border">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-xs text-muted-foreground tracking-wider font-light italic">
          Hongos que varían con las estaciones
        </p>
      </div>
    </footer>
  )
...
export default function Footer() {
  ...
  return theme === 'lovable' ? <FooterLovable /> : <FooterLocal />
}
